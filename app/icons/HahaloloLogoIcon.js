...
import { ReactComponent as Icon } from './HahaloloLogoIcon.svg';

export default function HahaloloLogoIcon(props) {
  return (
    <SvgIcon component={Icon} {...props}>
      <svg viewBox="0 0 24 24">
        <path d="M22 11.5c0-1-.2-1.9-.6-2.8-1.4-4.2-5.6-7-10-6.8h-.1c-1.7.2-3.4.7-4.9 1.8-4.6 3-5.8 9.2-2.8 13.9v.1c.2.2.3.6.6.8l.1.1c1.9 2.2 4.7 3.6 7.7 3.6h8.7c.8 0 1.3-.6 1.3-1.3v-8.6-.8z" />
        <path
          fill="#FFF"
